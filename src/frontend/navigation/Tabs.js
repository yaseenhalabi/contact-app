        ...
        >
            <Tab.Screen
                ...
                options={{
                    tabBarIcon: ({ focused }) => (
                        <Image
                            source={focused ? peopleIconFilled : peopleIcon}
            ...
            <Tab.Screen
                ...
                options={{
                    tabBarIcon: () => (
                        <Image source={addPersonIcon} style={{ width: 20, height: 25 }} />
                    ),
                }}
                listeners={({ navigation }) => ({
                    tabPress: (e) => {
                        e.preventDefault();
                        navigation.jumpTo('People', {
                            screen: 'ListOfNames',
                            params: { addingPerson: true },
                        });
                    },
                })}
            />
            ...
            <Tab.Screen
                ...
                options={{
                    tabBarIcon: () => (
                        <Image source={addTagIcon} style={{ width: 25, height: 25 }} />
                    ),
                }}
                listeners={({ navigation }) => ({
                    tabPress: (e) => {
                        e.preventDefault();
                        navigation.jumpTo('Tags', {
                            screen: 'ListOfTags',
                            params: { addingTag: true },
                        });
                    },
                })}
            />
            ...
            <Tab.Screen
                ...
                options={{
                    tabBarIcon: ({ focused }) => (
                        <Image
                            source={focused ? tagIconFilled : tagIcon}
